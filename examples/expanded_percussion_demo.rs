...
fn main() -> anyhow::Result<()> {
    ...
    comp.track("gong")
        .at(2.5)
        .drum(DrumType::Gong, 0.0);

    println!("3. Chimes (tubular bells)");
    comp.track("chimes")
        .at(6.5)
        .drum(DrumType::Chimes, 0.0)
        .wait(0.5)
        .drum(DrumType::Chimes, 0.0)
        .wait(0.5)
        .drum(DrumType::Chimes, 0.0);
    ...
    comp.track("tabla")
        .at(10.0)
        .drum(DrumType::TablaBayan, 0.0)
        .wait(0.2)
        .drum(DrumType::TablaDayan, 0.0)
        .wait(0.1)
        .drum(DrumType::TablaDayan, 0.0)
        .wait(0.2)
        .drum(DrumType::TablaBayan, 0.0)
    ...
    comp.track("reverse")
        .at(20.0)
        .drum(DrumType::ReverseCymbal, 0.0);

    println!("13. White Noise Hit");
    comp.track("noise")
        .at(22.0)
        .drum(DrumType::WhiteNoiseHit, 0.0)
        .wait(0.3)
        .drum(DrumType::WhiteNoiseHit, 0.0)
        .wait(0.3)
        .drum(DrumType::WhiteNoiseHit, 0.0);
