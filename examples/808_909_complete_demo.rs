...
fn main() -> anyhow::Result<()> {
    ...
    comp.track("808_basics")
        .at(0.0)
        .drum(DrumType::Kick808, quarter)
        .drum(DrumType::Snare808, quarter)
        .drum(DrumType::HiHat808Closed, eighth)
        .drum(DrumType::HiHat808Open, eighth)
        .drum(DrumType::Clap808, 0.0);

    // NEW: 808 Toms
    println!("   808 Toms (NEW):");
    comp.track("808_toms")
        .at(2.5)
        .drum(DrumType::Tom808Low, 0.3)
        .drum(DrumType::Tom808Mid, 0.3)
        .drum(DrumType::Tom808High, 0.0);

    // NEW: 808 Cowbell & Clave
    println!("   808 Cowbell & Clave (NEW):");
    comp.track("808_perc")
        .at(3.5)
        .drum(DrumType::Cowbell808, 0.25)
        .drum(DrumType::Cowbell808, 0.25)
        .drum(DrumType::Clave808, 0.25)
        .drum(DrumType::Clave808, 0.0);
    ...
    comp.track("909_basics")
        .at(5.0)
        .drum(DrumType::Kick909, quarter)
        .drum(DrumType::Snare909, 0.0);

    // NEW: 909 Hi-Hats
    println!("   909 Hi-Hats (NEW):");
    comp.track("909_hats")
        .at(6.0)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Open, 0.0);

    // NEW: 909 Clap, Cowbell, Rim
    println!("   909 Clap, Cowbell, Rim (NEW):");
    comp.track("909_perc")
        .at(7.5)
        .drum(DrumType::Clap909, quarter)
        .drum(DrumType::Cowbell909, quarter)
        .drum(DrumType::Rim909, 0.0);
    ...
    comp.track("transitions")
        .at(9.0)
        .drum(DrumType::ReverseSnare, 1.2)
        .drum(DrumType::Kick808, 0.0); // Drop after reverse

    // Cymbal swell
    comp.track("transitions2")
        .at(11.0)
        .drum(DrumType::CymbalSwell, 2.0)
        .drum(DrumType::Snare909, 0.0); // Hit after swell
    ...
    comp.track("808_groove_hats")
        ...
        .drum(DrumType::HiHat808Closed, eighth)
        .drum(DrumType::HiHat808Closed, eighth)
        .drum(DrumType::HiHat808Closed, 0.0);

    // Add cowbell on offbeats
    comp.track("808_groove_cowbell")
        .at(groove_start + eighth)
        .drum(DrumType::Cowbell808, quarter)
        .drum(DrumType::Cowbell808, quarter)
        .drum(DrumType::Cowbell808, quarter)
        .drum(DrumType::Cowbell808, 0.0);

    // Tom fill at end
    comp.track("808_groove_fill")
        .at(groove_start + half + quarter + eighth)
        .drum(DrumType::Tom808High, 0.15)
        .drum(DrumType::Tom808Mid, 0.15)
        .drum(DrumType::Tom808Low, 0.0);
    ...
    comp.track("909_groove_kick")
        ...
        .drum(DrumType::Kick909, quarter)
        .drum(DrumType::Kick909, quarter)
        .drum(DrumType::Kick909, 0.0);

    comp.track("909_groove_snare")
        .at(groove2_start + quarter)
        .drum(DrumType::Clap909, half)
        .drum(DrumType::Clap909, 0.0);

    comp.track("909_groove_hats")
        .at(groove2_start)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Open, eighth)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Closed, eighth)
        .drum(DrumType::HiHat909Open, eighth)
        .drum(DrumType::HiHat909Closed, 0.0);

    // Add rim clicks
    comp.track("909_groove_rim")
        .at(groove2_start + eighth)
        .drum(DrumType::Rim909, quarter)
        .drum(DrumType::Rim909, quarter)
        .drum(DrumType::Rim909, quarter)
        .drum(DrumType::Rim909, 0.0);
