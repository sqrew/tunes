...
fn main() -> anyhow::Result<()> {
    ...
    comp.track("poly")
        ...
        .drum_grid(16, 0.125)
        .kick(&euclidean(5, 16))
        .snare(&euclidean(3, 16))
        .hihat(&euclidean(11, 16));
