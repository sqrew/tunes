...
/// // Create phase vocoder with 2048 FFT, 512 hop, 44.1kHz
...
impl PhaseVocoder {
    ...
    /// ```
    /// # use tunes::synthesis::effects::spectral::PhaseVocoder;
    /// let vocoder = PhaseVocoder::new(44100.0);
    /// ```
    pub fn new(sample_rate: f32) -> Self {
        Self::with_params(sample_rate, 2048, 512)
    }
    ...
    /// let vocoder = PhaseVocoder::with_params(44100.0, 4096, 1024);
    /// ```
    pub fn with_params(sample_rate: f32, fft_size: usize, hop_size: usize) -> Self {
        Self {
            core: CorePhaseVocoder::new(fft_size, hop_size, sample_rate, WindowType::Hann),
...
/// // Create spectral freeze with default parameters
/// let mut freeze = SpectralFreeze::new(44100.0);
///
/// // Enable freeze to capture and hold spectrum
/// freeze.freeze();
///
/// // Set mix to 75% frozen, 25% live
/// freeze.set_mix(0.75);
///
/// // Process audio blocks
/// let mut buffer = vec![0.0; 512];
...
impl SpectralFreeze {
    ...
    /// ```
    /// # use tunes::synthesis::effects::spectral::SpectralFreeze;
    /// let freeze = SpectralFreeze::new(44100.0);
    /// ```
    pub fn new(_sample_rate: f32) -> Self {
        Self::with_params(2048, 512)
    }
    ...
    /// # use tunes::synthesis::effects::spectral::SpectralFreeze;
    /// // Larger FFT for better frequency resolution, more latency
    /// let freeze = SpectralFreeze::with_params(4096, 1024);
    /// ```
    pub fn with_params(fft_size: usize, hop_size: usize) -> Self {
        Self {
            core: CoreSpectralFreeze::new(fft_size, hop_size, WindowType::Hann),
...
/// // Create spectral gate with default parameters
...
impl SpectralGate {
    ...
    /// ```
    /// # use tunes::synthesis::effects::spectral::SpectralGate;
    /// let gate = SpectralGate::new(44100.0);
    /// ```
    pub fn new(sample_rate: f32) -> Self {
        Self::with_params(2048, 512, sample_rate)
    }
    ...
    /// # use tunes::synthesis::effects::spectral::SpectralGate;
    /// // Larger FFT for better frequency resolution, more latency
    /// let gate = SpectralGate::with_params(4096, 1024, 44100.0);
    /// ```
    pub fn with_params(fft_size: usize, hop_size: usize, sample_rate: f32) -> Self {
        Self {
            core: CoreSpectralGate::new(fft_size, hop_size, WindowType::Hann, sample_rate),
...
impl SpectralCompressor {
    ...
    pub fn with_params(fft_size: usize, hop_size: usize, sample_rate: f32) -> Self {
        Self {
            core: CoreSpectralCompressor::new(
                fft_size,
                hop_size,
...
impl SpectralRobotize {
    /// Create a new spectral robotize with default FFT settings (2048/512)
    pub fn new(sample_rate: f32) -> Self {
        Self::with_params(2048, 512, sample_rate)
    }
    ...
    pub fn with_params(fft_size: usize, hop_size: usize, _sample_rate: f32) -> Self {
        Self {
            core: CoreSpectralRobotize::new(
                fft_size,
                hop_size,
                crate::synthesis::spectral::WindowType::Hann,
            ),
...
mod tests {
    ...
    fn test_spectral_compressor_creation() {
        let comp = SpectralCompressor::new(44100.0);
        assert!(comp.enabled);
    ...
    fn test_spectral_compressor_with_params() {
        let comp = SpectralCompressor::with_params(4096, 1024, 44100.0);
        assert!(comp.enabled);
    }
    ...
    fn test_spectral_robotize_creation() {
        let robotize = SpectralRobotize::new(44100.0);
    ...
    fn test_spectral_robotize_with_params() {
        let robotize = SpectralRobotize::with_params(4096, 1024, 44100.0);
        assert!(robotize.enabled);
    }
}
